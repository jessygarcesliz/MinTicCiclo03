 ...
 */
 ...
 router.get('/products/serials/:serialId', productController.filterProductBySerial);
 
 router.get('/products/names/:productName', productController.filterProductByName);
